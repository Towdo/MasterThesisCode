...
from data import dinoSketchSet, dinoSketchSetPlusVector
...
if __name__ == "__main__":
    ...
    dataset = dinoSketchSetPlusVector(root, min_occurrences=20, graphstyle = config["graphstyle"]) #graphstyle
    #print(dataset.num_classes_)
    #dataset.num_classes_ = 40
    ...
    with torch.no_grad():
        dat = testset[7624]#[17]  #0 sheep, 35 giraffe   , 48 dog, 49 patch_limn, 54 hydrant, 59 signboard, 68 weird dog
        vector_sketch, rasterized_sketch, rasterized_strokes, spatial_edge_list, temporal_edge_list, spatial_dist = dat
        ...
        labels = preds#batch["stroke"].label#preds
