...
class dinoSketchSet(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return rasterized_sketch, rasterized_strokes, spatial_edge_list, temporal_edge_list, spatial_dist

class dinoSketchSetPlusVector(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return vector_sketch, rasterized_sketch, rasterized_strokes, spatial_edge_list, temporal_edge_list, spatial_dist
...
class dinoSketchSetAnnotated(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return rasterized_sketch, rasterized_strokes, spatial_edge_list, temporal_edge_list, spatial_dist, labels
